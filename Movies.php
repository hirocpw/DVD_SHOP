...
<body>
		...
		<form>
		<button class = "moviebutton" type = "submit" formaction = "showall.php"> Show All Movies</a></button>
		<button class = "moviebutton" type = "submit" formaction = "showactor.php"> Search by Actor</a></button>
		<button class = "moviebutton" type = "submit" formaction = "showdirector.php"> Search by Director</a></button>
		<button class = "moviebutton" type = "submit" formaction = "showgenre.php"> Search by Genre</a></button>
		<button class = "moviebutton" type = "submit" formaction = "classi.php"> Search by Classification</a></button><br><br>
		<button class = "moviebutton" type = "submit" formaction = "admin_movie.php"> Admin</a></button>
		<button class = "moviebutton" type = "submit" formaction = "admin_member.php"> Member Login</a></button>
		</form>
		<?php
			echo "<h2>New Release</h2>";
